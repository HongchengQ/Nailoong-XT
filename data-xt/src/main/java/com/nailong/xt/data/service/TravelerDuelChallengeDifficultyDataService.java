...
public class TravelerDuelChallengeDifficultyDataService {
    ...
    public ArrayList<TravelerDuelChallengeDifficultyConfig> getAllTravelerDuelChallengeDifficultyData() {
        return new ArrayList<>(gameDataMgr.getTravelerDuelChallengeDifficultyConfigMap().values());
    }
}
