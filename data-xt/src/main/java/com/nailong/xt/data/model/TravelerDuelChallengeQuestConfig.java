...
/**
 * 自动生成的配置类。
 * 对应文件: TravelerDuelChallengeQuest.json
 */
@ToString
@Builder
@EqualsAndHashCode
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class TravelerDuelChallengeQuestConfig {

    private final Integer id;
    private final Integer groupId;
    private final String title;
    private final List<Integer> affixJumpTo;
    ...
    @JsonCreator
    public TravelerDuelChallengeQuestConfig(
        @JsonProperty("Id") Integer id,
        @JsonProperty("GroupId") Integer groupId,
        @JsonProperty("Title") String title,
        @JsonProperty("AffixJumpTo") List<Integer> affixJumpTo,
        ...
        this.title = title;
        this.affixJumpTo = affixJumpTo != null ? 
            new ArrayList<>(affixJumpTo) : 
            new ArrayList<>();
    ...
    public List<Integer> getAffixJumpTo() {
        return this.affixJumpTo;
    }
