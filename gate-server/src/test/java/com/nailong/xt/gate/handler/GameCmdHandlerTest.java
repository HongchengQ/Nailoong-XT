...
////        Package.CmdRequestContext context = new Package.CmdRequestContext(1002, protoData);
//        Package.CmdRequestContext context = Package.CmdRequestContext.newBuilder()
//                .setCmdId(1002)
//                .setProtoData(ByteString.copyFrom(protoData))
//                .build();
//
//        byte[] result = gameCmdHandler.handleMoveRequest(context).toByteArray();
//
//        assertNotNull(result);
...
//                return GameCmdHandler.class.getMethod("handleMoveRequest", Package.CmdRequestContext.class)
//                        .getAnnotation(CmdHandler.class).value();
